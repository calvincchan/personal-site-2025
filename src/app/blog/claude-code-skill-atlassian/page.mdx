...
Instead, I used [`atlassian-cli`](https://github.com/omar16100/atlassian-cli) by omar16100 — a community-built Rust binary that covers all three products with a consistent interface. It's Homebrew-installable, actively maintained, and handles everything from issue transitions to Confluence space management.
